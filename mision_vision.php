...
<html lang="en">
    <head>
        ...
        <title>Meykos - Mision y Vision</title>
            ...
            <div id="layoutSidenav_content" class="bg-primary">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Mision y Vision</h1>
                            <div class="row">
                                <div class="card col p-0 mr-3">
                                    <img src="assets/img/Proposito.png" alt="Proposito" class="card-img-top img-fluid">
                                    <div class="card-body">
                                        <h3 class="card-title">Mision</h3>
                                        <p class="card-text">
                                            Somos una empresa que brinda soluciones para la salud y bienestar de nuestros clientes, 
                                            con productos y servicios de calidad, a través de una experiencia de compra superior.
                                        </p>
                                ...
                                <div class="card col p-0 mr-3">
                                    <img src="assets/img/Vision.jpg" alt="Vision" class="card-img-top img-fluid">
                                    <div class="card-body">
                                        <h3 class="card-title">Vision</h3>
                                        <p class="card-text">
                                            Ser reconocidos por nuestros clientes como la mejor opción en soluciones de salud y bienestar.
                                        </p>
                                        <button type="button" class="btn btn-success" onclick="location.href='https://meykos.com/'">Ver mas...</button>
                                    </div>
                                </div>
