<?php
    ...
    if($_POST){
        ...
        $sql = "SELECT idUsuario, Usuario, Contrasena, Rol FROM usuario WHERE usuario='$usuario'";
                                        ...
                                        <div class="card-body">
                                            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-4" id="inputPassword" name="password" type="password" placeholder="Ingrese su password" />
                                                </div>
                                                <div class="form-group">
                    ...
                    <footer class="py-4 bg-dark mt-auto">
                        <div class="container-fluid">
                            <div class="d-flex align-items-center justify-content-between small">
                                <div class="text-white">Copyright &copy; Meykos 2021</div>
                                <div>
